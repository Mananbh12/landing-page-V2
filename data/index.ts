...
export const gridItems = [
  {
    img: "https://images.unsplash.com/photo-1561710309-cc4cd327effa?q=80&w=1964&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    description:
      "Nous sommes une entreprise familiale qui offre notre expertise de plus de 25 ans dans le domaine des sols d'intérieur tant à des promoteurs immobiliers qu'à des particuliers.",
    className: "max-w-6xl mx-auto px-4 min-h-[30rem]",
  },
];
